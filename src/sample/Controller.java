...
public class Controller {
    ...
    private final ArrayList<ImageView> playersImages = new ArrayList<>(); // TODO
    private boolean isGameFinished = false;

    public double widthSize = 500.0; // عرض صفحه
    public double heightSize = 500.0; // ارتفاع صفحه
    private int boardSize = 8;  // ابعاد اولیه
    ...
    public int[] calculatePositionOfElement (double x, double y, int boardSize) {
        ...
        double stepWidth = widthSize / boardSize; // 500.0 / 8 -> 62.5
